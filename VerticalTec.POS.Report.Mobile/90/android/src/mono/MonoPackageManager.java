...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "VerticalTec.POS.Report.Mobile.Android.dll" comes first in this list. */
		"VerticalTec.POS.Report.Mobile.Android.dll",
		"FormsViewGroup.dll",
		"VerticalTec.POS.Report.Mobile.dll",
